...
public class SetTest {
    ...
    public void addNotCrossInterval() {
        ...
        Interval interval2 = new Interval(-1.0, 20.0);
        Interval interval3 = new Interval(10.0, 30.0);
        boolean result1 = set.addNotCrossInterval(interval1);
        boolean result2 = set.addNotCrossInterval(interval2);
        boolean result3 = set.addNotCrossInterval(interval3);
        boolean expected1 = true;
        boolean expected2 = false;
        boolean expected3 = true;
        boolean result4 = set.getSet().contains(interval1);
        boolean result5 = set.getSet().contains(interval2);
